...
class IntraZPConv(nn.Module):
    def __init__(self, dim_in, dim_out, kernel_size,
        ...
        self.register_buffer('anchor_out', anchor_out, persistent=False)
        self.register_buffer('kernels', kernels, persistent=False)
        self.register_buffer('intra_idx', intra_idx, persistent=False)
        self.register_buffer('intra_w', intra_w, persistent=False)
